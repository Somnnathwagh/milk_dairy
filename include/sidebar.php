<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li class="menu-label">Configration</li>
				<li>
					...
					<ul>        
						<li> <a href="add_customer.php"><i class="bx bx-right-arrow-alt"></i>Add Customer</a>
						</li>
						<li> <a href="show_customer.php"><i class="bx bx-right-arrow-alt"></i>Show Customer</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="errors-404-error.php" target="_blank"><i class="bx bx-right-arrow-alt"></i>404 Error</a></li>
